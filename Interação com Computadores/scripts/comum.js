...
window.onload = function () {
    ...
    }else if(localStorage.getItem("partilha") == 'Nao ativa'){
        // document.getElementById('container').removeChild(divPartilha);
    ...
    if (atual == "Ativa"){
        if (chamadaAtiva != null  && paginaAtual != "chamadaVideoAuto" && paginaAtual != "paginaEspera"  && paginaAtual != "paginaReset") {
            ...
            botaoDesligar.setAttribute('id','btnDesligar');
...
function apagaTudo(){
    localStorage.clear();
    location.href ="paginaReset.html";
}