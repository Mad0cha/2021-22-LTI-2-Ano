...
function mostraEscuro(){
    var escuro = document.getElementById('imgDarkMode');
    escuro.classList.add("show");
}
...
function escondeEscuro(){
    var escuro = document.getElementById('l2');
    escuro.classList.remove("show");
}
