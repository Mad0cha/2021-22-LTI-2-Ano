                ...
                if lista_comando[1] not in ["UTILIZADOR", "ARTISTA", "MUSICA"]:
                    ...
                    if lista_comando[1].isnumeric() and lista_comando[2].isnumeric() and lista_comando[3].isnumeric() == False:
                        ...
                        if len(lista_comando) < 4:
                            ...
                            r = requests.post('https://localhost:5000/musicas/avaliacoes', json=dados_playlist, verify='../certs/root.pem',cert=('../certs/cli.crt','../certs/cli.key'))
                    ...
                    if lista_comando[1] == "UTILIZADOR":
                        ...
                        if len(lista_comando) < 4:
                            ...
                            r = requests.post('https://localhost:5000/utilizadores/', json=dados_utilizador,verify='../certs/root.pem',cert=('../certs/cli.crt','../certs/cli.key'))
                            print ("Status: " + str(r.status_code))
                            print (r.content.decode())
                            print (r.headers)
                            print ('***')
                    ...
                    ####### ARTISTA ########
                        ...
                        if len(lista_comando) < 3:
                            ...
                            r = requests.post('https://localhost:5000/artistas/', json=dados_artista,verify='../certs/root.pem',cert=('../certs/cli.crt','../certs/cli.key'))
                            print ("Status: " + str(r.status_code))
                            print (r.content.decode())
                            print (r.headers)
                            print ('***')
                    ...
                    ####### MUSICA ########
                        ...
                        if len(lista_comando) < 3:
                            ...
                            r = requests.post('https://localhost:5000/musicas/', json=dados_musica,verify='../certs/root.pem',cert=('../certs/cli.crt','../certs/cli.key'))
                            print ("Status: " + str(r.status_code))
                            print (r.content.decode())
                            print (r.headers)
                            print ('***')
            ...
            if lista_comando[0] == "READ":
                ...
                if lista_comando[1] == "UTILIZADOR":
                    if len(lista_comando) < 3:
                        ...
                        r = requests.get('https://localhost:5000/utilizadores/' + str(lista_comando[2]), json=dados_json,verify='../certs/root.pem',cert=('../certs/cli.crt','../certs/cli.key'))
                        print ("Status: " + str(r.status_code))
                        print (r.content.decode())
                        print (r.headers)
                        print ('***')
                ...
                ####### ARTISTA ########
                    ...
                    if len(lista_comando) < 3:
                        ...
                        r = requests.get('https://localhost:5000/artistas/' + str(lista_comando[2]),verify='../certs/root.pem',cert=('../certs/cli.crt','../certs/cli.key'))
                        print ("Status: " + str(r.status_code))
                        print (r.content.decode())
                        print (r.headers)
                        print ('***')
                ...
                ####### MUSICA ########
                    ...
                    if len(lista_comando) < 3:
                        ...
                        r = requests.get('https://localhost:5000/musicas/' + str(lista_comando[2]),verify='../certs/root.pem',cert=('../certs/cli.crt','../certs/cli.key'))
                        print ("Status: " + str(r.status_code))
                        print (r.content.decode())
                        print (r.headers)
                        print ('***')
                    ...
                    if len(lista_comando) < 3:
                        ...
                        if lista_comando[2] == "MUSICAS":
                            ...
                            if len(lista_comando) == 3:
                                ...
                                if lista_comando[3] not in ["M", "m", "S", "B", "MB"]:
                                    ...
                                    r = requests.get('https://localhost:5000/musicas/all/avaliacoes/', json=dados_avaliacao,verify='../certs/root.pem',cert=('../certs/cli.crt','../certs/cli.key'))
                                    print ("Status: " + str(r.status_code))
                                    print (r.content.decode())
                                    print (r.headers)
                                    print ('***')
                        ...
                        if lista_comando[2] == "MUSICAS_A":
                            if len(lista_comando) < 4:
                                ...
                                r = requests.get('https://localhost:5000/musicas/all/artista/' + str(lista_comando[3]),verify='../certs/root.pem',cert=('../certs/cli.crt','../certs/cli.key'))
                                print ("Status: " + str(r.status_code))
                                print (r.content.decode())
                                print (r.headers)
                                print ('***')
                        ...
                        if lista_comando[2] == "MUSICAS_U":
                            if len(lista_comando) < 4:
                                ...
                                r = requests.get('https://localhost:5000/musicas/all/utilizador/' + str(lista_comando[3]),verify='../certs/root.pem',cert=('../certs/cli.crt','../certs/cli.key'))
                                print ("Status: " + str(r.status_code))
                                print (r.content.decode())
                                print (r.headers)
                                print ('***')
            ...
            if lista_comando[0] == "DELETE":
                ...
                if lista_comando[1] == "UTILIZADOR":
                    if len(lista_comando) < 3:
                        ...
                        r = requests.delete('https://localhost:5000/utilizadores/' + str(lista_comando[2]),verify='../certs/root.pem',cert=('../certs/cli.crt','../certs/cli.key'))
                        print ("Status: " + str(r.status_code))
                        print (r.content.decode())
                        print (r.headers)
                        print ('***')
                ...
                ####### ARTISTA ########
                    ...
                    if len(lista_comando) < 3:
                        ...
                        r = requests.delete('https://localhost:5000/artistas/' + str(lista_comando[2]),verify='../certs/root.pem',cert=('../certs/cli.crt','../certs/cli.key'))
                        print ("Status: " + str(r.status_code))
                        print (r.content.decode())
                        print (r.headers)
                        print ('***')
                ...
                ####### MUSICA ########
                    ...
                    if len(lista_comando) < 3:
                        ...
                        r = requests.delete('https://localhost:5000/musicas/' + str(lista_comando[2]),verify='../certs/root.pem',cert=('../certs/cli.crt','../certs/cli.key'))
                        print ("Status: " + str(r.status_code))
                        print (r.content.decode())
                        print (r.headers)
                        print ('***')
                    ...
                    if len(lista_comando) < 3:
                        ...
                        if lista_comando[2] == "MUSICAS":
                            if len(lista_comando) < 3:
                                ...
                                ####### ALL MUSICAS AVALIACAO ########
                                    ...
                                    dados_avaliacao = {"avaliacao" : lista_comando[3]}
                                    r = requests.delete('https://localhost:5000/musicas/all/avaliacoes/', json=dados_avaliacao,verify='../certs/root.pem',cert=('../certs/cli.crt','../certs/cli.key'))
                                    print ("Status: " + str(r.status_code))
                                    print (r.content.decode())
                                    print (r.headers)
                                    print ('***')
                        ...
                        if lista_comando[2] == "MUSICAS_A":
                            if len(lista_comando) < 4:
                                ...
                                r = requests.delete('https://localhost:5000/musicas/all/artista/' + str(lista_comando[3]),verify='../certs/root.pem',cert=('../certs/cli.crt','../certs/cli.key'))
                                print ("Status: " + str(r.status_code))
                                print (r.content.decode())
                                print (r.headers)
                                print ('***')
                        ...
                        if lista_comando[2] == "MUSICAS_U":
                            if len(lista_comando) < 4:
                                ...
                                r = requests.delete('https://localhost:5000/musicas/all/utilizador/' + str(lista_comando[3]),verify='../certs/root.pem',cert=('../certs/cli.crt','../certs/cli.key'))
                                print ("Status: " + str(r.status_code))
                                print (r.content.decode())
                                print (r.headers)
                                print ('***')
            ...
            if lista_comando[0] == "UPDATE":
                ...
                if lista_comando[1] == "UTILIZADOR":
                    if len(lista_comando) < 4:
                        ...
                        r = requests.put('https://localhost:5000/utilizadores/', json=dados_utilizador,verify='../certs/root.pem',cert=('../certs/cli.crt','../certs/cli.key'))
                        print ("Status: " + str(r.status_code))
                        print (r.content.decode())
                        print (r.headers)
                        print ('***')
                ...
                if lista_comando[1] == "MUSICA":
                    if len(lista_comando) < 5:
                        ...
                        r = requests.put('https://localhost:5000/musicas/avaliacoes', json=dados_playlist,verify='../certs/root.pem',cert=('../certs/cli.crt','../certs/cli.key'))
                        print ("Status: " + str(r.status_code))
                        print (r.content.decode())
                        print (r.headers)
                        print ('***')