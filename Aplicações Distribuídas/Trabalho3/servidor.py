...
def utilizadores(id = None):
    ...
    if request.method == "POST":
        ...
        if request.url == "http://localhost:5000/utilizadores/":
    ...
    if request.method == "PUT":
        ...
        if request.url == "http://localhost:5000/utilizadores/":
            ...
            if resultado == []:
                erro = json.dumps({'describedBy':"http://localhost:5000/suporte/", 'httpStatus':'404', 'title':"O utilizador com id " + dados_cliente["id"] + " não existe"})
                ...
                r.headers['location'] = 'http://localhost:5000/utilizadores/'+ dados_cliente["id"]
    ...
    if request.method == "GET":
        ...
        if request.url == "http://localhost:5000/utilizadores/" + str(id):
            ...
            if user is not None:
                ...
                erro = json.dumps({'describedBy':"http://localhost:5000/suporte/", 'httpStatus':'404', 'title':'O utilizador com id = ' + str(id) + ' não existe!'})
                r = make_response(erro)
                r.status_code = 404
            conn.close()
            return r
        ...
        if request.url == "http://localhost:5000/utilizadores/all/":
            ...
            if users != []:
                ...
                erro = json.dumps({'describedBy':"http://localhost:5000/suporte/", 'httpStatus':'404', 'title':'Ainda não existem utilizadores!'})
                r = make_response(erro)
                r.status_code = 404
...
def artistas(id = None):
    ...
    if request.method == "POST":
        ...
        if request.url == "http://localhost:5000/artistas/":
            dados_cliente = json.loads(request.data)
            dados_spotify = requests.get("https://api.spotify.com/v1/artists/" + dados_cliente["id_spotify"], headers=header).json()
            ...
            try:
                ...
                if resultado != []:
                    ...
                    id = cursor.fetchall()
                    r.headers['location'] = "http://localhost:5000/artistas/" + str(id)
    ...
    if request.method == "GET":
        ...
        if request.url == "http://localhost:5000/artistas/" + str(id):
            cursor.execute("SELECT * FROM artistas WHERE id = ?", (str(id),))
            row = cursor.fetchone()
           
            if row is not None:
                dados_spotify = requests.get("https://api.spotify.com/v1/artists/" + row[1], headers=header).json()
                r = make_response(dados_spotify)
                ...
                erro = json.dumps({'describedBy':"http://localhost:5000/suporte/", 'httpStatus':'404', 'title':'O artista com id = ' + str(id) + ' não existe!'})
                r = make_response(erro)
                r.status_code = 404
        ...
        # READ ALL ARTISTAS
        if request.url == "http://localhost:5000/artistas/all/":
            ...
            if rows != []:
                ...
                erro = json.dumps({'describedBy':"http://localhost:5000/suporte/", 'httpStatus':'404', 'title':'Ainda não existem artistas!'})
                r = make_response(erro)
                r.status_code = 404
...
def musicas(id = None):
    ...
    # CREATE MUSICA
    if request.method == "POST":
        if request.url == "http://localhost:5000/musicas/":
            dados_cliente = json.loads(request.data)
            dados_spotify = requests.get("https://api.spotify.com/v1/tracks/" + dados_cliente["id_spotify"], headers=header).json()
            ...
            try:
                ...
                if resultado != []:
                    ...
                    id = cursor.fetchall()
                    r.headers['location'] = "http://localhost:5000/musicas/" + str(id[0][0])
        ...
        if request.url == "http://localhost:5000/musicas/avaliacoes":
            ...
            try:
                ...
                if id_avaliacao is None:
                    erro = json.dumps({'describedBy':"http://localhost:5000/suporte/", 'httpStatus':'404', 'title':'A avaliação ' + dados_cliente["avaliacao"] + ' não existe'})
                    r = make_response(erro)
                    r.status_code = 404
                else:
                ...
                if id_user is None:
                    erro = json.dumps({'describedBy':"http://localhost:5000/suporte/", 'httpStatus':'404', 'title':'O utilizador com id = ' + str(dados_cliente["id_user"]) + ' não existe!'})
                    r = make_response(erro)
                    r.status_code = 404
                else: 
                    ...
                    if id_musica is None:
                        erro = json.dumps({'describedBy':"http://localhost:5000/suporte/", 'httpStatus':'404', 'title':'A música com id = ' + str(dados_cliente["id_musica"]) + ' não existe!'})
                        r = make_response(erro)
                        r.status_code = 404
                    else:
                        erro = json.dumps({'describedBy':"http://localhost:5000/suporte/", 'httpStatus':'409', 'title':'O utilizador já avaliou essa música!'})
                        r = make_response(erro)
                        r.status_code = 409
                conn.close()
                return r
    ...
    if request.method == "PUT": 
        if request.url == "http://localhost:5000/musicas/avaliacoes":
            ...
            if row is None:
                erro = json.dumps({'describedBy':"http://localhost:5000/suporte/", 'httpStatus':'404', 'title':'Não existe nenhuma avaliação para a música pretendida por esse utilizador'})
                r = make_response(erro)
                r.status_code = 404
    ...
    if request.method == "GET":
        ...
        if request.url == "http://localhost:5000/musicas/" + str(id):
            cursor.execute("SELECT * FROM musicas WHERE id = ?", (str(id),))
            row = cursor.fetchone()
            
            if row is not None:
                dados_spotify = requests.get("https://api.spotify.com/v1/tracks/" + row[1], headers=header).json()
                r = make_response(dados_spotify)
                ...
                erro = json.dumps({'describedBy':"http://localhost:5000/suporte/", 'httpStatus':'404', 'title':'A musica com id = ' + str(id) + ' não existe!'})
                r = make_response(erro)
                r.status_code = 404
        ...
        # READ ALL MUSICAS 
        if request.url == "http://localhost:5000/musicas/all/":
            ...
            if rows != []:
                ...
                erro = json.dumps({'describedBy':"http://localhost:5000/suporte/", 'httpStatus':'404', 'title':'Ainda não existe nenhuma musica!'})
                r = make_response(erro)
                r.status_code = 404
        ...
        if request.url == "http://localhost:5000/musicas/all/artista/" + str(id):
            cursor.execute("SELECT * FROM artistas WHERE id = ?", (str(id),))
            row = cursor.fetchone()
            ...
            if row is not None:
                ...
                if musicas != []:
                    ...
                    erro = json.dumps({'describedBy':"http://localhost:5000/suporte/", 'httpStatus':'404', 'title':'O artista com id = ' + str(id) + ' não tem nenhuma musica avaliada!'})
                    r = make_response(erro)
                    r.status_code = 404
        ...
        if request.url == "http://localhost:5000/musicas/all/utilizador/" + str(id):
            ...
            if musicas != []:
                ...
                if users == []:
                    ...
                    erro = json.dumps({'describedBy':"http://localhost:5000/suporte/", 'httpStatus':'404', 'title':'Não existe nenhuma música avaliada pelo o utilizador com id = ' + str(id) })
                    r = make_response(erro)
                    r.status_code = 404
        ...
        if request.url == "http://localhost:5000/musicas/all/avaliacoes/":
            dados_cliente = json.loads(request.data)
            cursor.execute("SELECT id FROM avaliacoes WHERE sigla = ?", (dados_cliente["avaliacao"],))
            id_avaliacao = cursor.fetchone()
            ...
            if id_avaliacao is None:
                ...
                if musicas != []:
                    ...
                    erro = json.dumps({'describedBy':"http://localhost:5000/suporte/", 'httpStatus':'404', 'title':'Não existe nenhuma música avaliada com ' + dados_cliente["avaliacao"] })
                    r = make_response(erro)
                    r.status_code = 404
    ...
    if request.method == "DELETE":
        ...
        if request.url == "http://localhost:5000/musicas/" + str(id):
            ...
            if id_spotify is None:
                erro = json.dumps({'describedBy':"http://localhost:5000/suporte/", 'httpStatus':'404', 'title':'A música com id = ' + str(id) + ' não existe!'})
                r = make_response(erro)
                r.status_code = 404
        ...
        if request.url == "http://localhost:5000/musicas/all/":
            ...
            if rows != []:
                ...
                erro = json.dumps({'describedBy':"http://localhost:5000/suporte/", 'httpStatus':'404', 'title':'Ainda não existem musicas!'})
                r = make_response(erro)
                r.status_code = 404
        ...
        if request.url == "http://localhost:5000/musicas/all/artista/" + str(id):
            ...
            if row is not None:
                ...
                if musicas != []:
                    ...
                    erro = json.dumps({'describedBy':"http://localhost:5000/suporte/", 'httpStatus':'404', 'title':"O artista com o id = " + str(id) + " não tem músicas avaliadas"})
                    r = make_response(erro)
                    r.status_code = 404
        ...
        if request.url == "http://localhost:5000/musicas/all/utilizador/" + str(id):
            ...
            if musicas != []:
                ...
                if users == []:
                    ...
                    erro = json.dumps({'describedBy':"http://localhost:5000/suporte/", 'httpStatus':'404', 'title':"O utilizador com o id = " + str(id) + " ainda não avaliou nenhuma música"})
                    r = make_response(erro)
                    r.status_code = 404
